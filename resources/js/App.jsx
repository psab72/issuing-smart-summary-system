...
export default function App() {
    ...
    const { issues, meta, loading, error, reload } = useIssues(
        user ? filters : null,
    );
        ...
        <div className="flex h-screen overflow-hidden">
            ...
            <nav className="w-52 flex-shrink-0 bg-[#161b24] border-r border-[#2a3347] flex flex-col">
                <div className="flex items-center gap-2.5 px-4 py-5 border-b border-[#2a3347]">
                    ...
                    <span className="font-mono font-semibold text-[15px] tracking-wide text-slate-100">
                        IssueOps
                    </span>
                </div>
            ...
            <main className="flex-1 overflow-y-auto p-7 relative">
                ...
                {toast && (
                    <div
                        className={`fixed top-5 right-6 z-50 px-4 py-2.5 rounded-md text-[13.5px] font-medium animate-fade-in ${toastColors[toast.type]}`}
                    >
                        {toast.msg}
                    </div>
                )}
                    ...
                    <>
                        <div className="mb-6">
                            <button
                                ...
                                className="text-[13px] text-slate-400 hover:text-blue-400 mb-1.5 block transition-colors"
                            >
                                ← Back
                            </button>
                            <h1 className="text-[22px] font-semibold tracking-tight text-slate-100">
